...
var template_compromisos = '<div class="card"><div class="card-header" role="tab" id="headingOne"><h5 class="mb-0"><a data-toggle="collapse" href="#{{id_container_compromiso}}" aria-expanded="true">{{compromiso1}}<span class="pull-right {{color}}"">{{Prioridad}}</span></a></h5></div> <div id="{{id_container_compromiso}}" class="collapse " role="tabpanel"  data-parent="#accordion"><div class="card-body"><div class="row form-group"><div class="col-lg-12 col-md-12 col-sm-12"><label>Decripción</label><div class="detalle_descripcion">{{descripcion}}</div></div></div><div class="row"><div class="col-lg-6 col-md-6 col-sm-12 form-group"><label>Dirección Responsable</label><div class="detalle_descripcion">"{{direccion_responsable}}"></div></div><div class="col-lg-6 col-md-6 col-sm-12 form-group"><label>Plazo Total</label><div class="detalle_descripcion">{{situacion_actual}}></div></div></div><div class="row"><div class="col-lg-6 col-md-6 col-sm-12 form-group"><label>Término de Plazo</label><div class="detalle_descripcion">{{termino_plazo}}"</div> </div><div class="col-lg-6 col-md-6 col-sm-12 form-group"><label>Plazo Faltante</label><div class="detalle_descripcion">{{plazo_faltante}}</div></div> </div> <div class="row"><div class="col-lg-6 col-md-6 col-sm-12 form-group"><label>Estado</label> <div class="detalle_descripcion">{{estado}}</div></div><div class="col-lg-6 col-md-6 col-sm-12 form-group"><label>Prioridad</label><div class="detalle_descripcion">{{Prioridad}}</div></div> </div> <div><button type= "button" class="btn btn-primary" data-toggle="modal" data-target="#1{{id_container_compromiso}}" id="detalle">Información Ampliada</button></div></div> </div></div> <div class="modal fade" id="#1{{id_container_compromiso}}" tabindex="-1" role="dialog"  aria-hidden="true"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-body"><div class="container"><div class="row form-group"><div class="col-lg-12 col-md-12 col-sm-12"><label>Nombre</label><div class="detalle_descripcion">{{compromiso1}}</div></div></div><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 form-group"><label>Documento Fuente</label><div class="detalle_descripcion">{{documento_fuente}}</div></div></div><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 form-group"><label>Descripcion</label><div class="detalle_descripcion">{{descripcion}}</div></div></div><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 form-group"><label>Dirección Oficina </label><div class="detalle_descripcion">{{direccion_responsable}</div></div></div><div class="row"><div class="col-md-6 col-lg-6 col-sm-12  form-group"><label>Situación Actual</label><div class="detalle_descripcion">{{situacion_actual}}</div></div><div class="col-md-6 col-lg-6 col-sm-12  form-group"><label>Prioridad</label><div class="detalle_descripcion">{{Prioridad}}</div></div></div><div class="row"><div class="col-md-6 col-lg-6 col-sm-12  form-group"><label>Fecha de Compromiso</label><div class="detalle_descripcion">{{fecha_compromiso}}</div></div><div class="col-md-6 col-lg-6 col-sm-12  form-group"><label>Tipo de Plazo</label><div class="detalle_descripcion">{{tipo_de_Plazo}}</div></div></div><div class="row "><div class="col-md-4 col-lg-4 col-sm-12  "><label>Tipo de Moneda</label><div class="detalle_descripcion">{{tipo_moneda}}</div></div><div class="col-md-4 col-lg-4 col-sm-12"><label>Inversion</label><div class="detalle_descripcion">{{inversion}}</div></div><div class="col-md-4 col-lg-4 col-sm-12"><label>Termino Plazo</label><div class="detalle_descripcion">{{termino_plazo}}</div></div></div><div class="row"><div class="col-md-6 col-lg-6 col-sm-12  form-group"><label>Plazo Total</label><div class="detalle_descripcion">{{Plazo Total}}</div></div><div class="col-md-6 col-lg-6 col-sm-12  form-group"><label>Plazo Faltante</label><div class="detalle_descripcion">{{Plazo_faltante}}</div></div></div></div></div></div></div></div>';
...
function llenarCompromisos(mesa_nombre) {
  ...
  $(compromisos).each(function (i, compromiso) {
    ...
    compromiso_html += template_compromisos.replace(/{{compromiso1}}/g , compromiso['nombre']).replace(/{{plazo_faltante}}/g ,compromiso['plazo_faltante']).replace(/{{pendiente}}/g , compromiso['pendiente']).replace(/{{descripcion}}/g,compromiso['descripcion']).replace(/{{id_container_compromiso}}/g,compromiso['nombre']).replace(/{{direccion_responsable}}/g, compromiso['direccion_responsable']).replace(/{{situacion_actual}}/g ,compromiso['situacion_actual']).replace(/{{termino_plazo}}/g,compromiso['fecha_cumplimiento']).replace(/{{estado}}/g,compromiso['estado']).replace(/{{inversion}}/g,compromiso['inversion']).replace(/{{tipo_de_Plazo}}/g,compromiso['tipo_de_Plazo']).replace(/{{documento_fuente}}/g,compromiso['documento_fuente']).replace(/{{fecha_compromiso}}/g , compromiso['fecha_de_compromiso']).replace(/{{Prioridad}}/g,compromiso['prioridad']);
  });
